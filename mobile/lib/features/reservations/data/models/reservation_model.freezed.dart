...
class _$ReservationModelImpl extends _ReservationModel {
  ...
  @override
  String toString() {
    return 'ReservationModel(id: $id, userId: $userId, date: $date, timeSlotId: $timeSlotId, guests: $guests, status: $status, name: $name, phone: $phone, email: $email, notes: $notes, startTime: $startTime, endTime: $endTime, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _ReservationModel extends ReservationModel {
  const factory _ReservationModel(
      ...
      required final DateTime updatedAt}) = _$ReservationModelImpl;
